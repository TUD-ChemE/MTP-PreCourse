...
Peclet number for mass transport, denoted by $Pe_{M}$ is given by:  
$$
\textrm{Pe$_M$}=\frac{vL}{\mathcal{D}} \nonumber
$$
...
Fourier number for mass transport, denoted by $Fo_{M}$ is given by:  
$$
\textrm{Fo$_M$}=\frac{t}{t_c}=\frac{t}{L^2/\mathcal{D}}=\frac{\mathcal{D} t}{L^2} \nonumber
$$
