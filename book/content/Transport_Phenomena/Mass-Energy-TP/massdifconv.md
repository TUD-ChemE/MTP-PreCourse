...
:align: center
```
**Note:** A video for the solutions from {numref}`Exercise1md` to {numref}`Exercise4md` is provided in {numref}`Exercise4md`.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/6NDiCyRdwXk?si=yPj8kGmi_n-3Sdg4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:label: Solution5md
:class: dropdown
**Note:** A video for the solutions from {numref}`Exercise5md` to {numref}`Exercise6md` is provided in {numref}`Exercise6md`.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/4HUlQMaDcb4?si=qpA1UjbvBzW_2UMf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
```
